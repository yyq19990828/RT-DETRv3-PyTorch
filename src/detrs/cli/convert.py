...
Examples:
  ...
  python -m detrs.cli.convert --batch --input 'checkpoints/*.pdparams' --output converted --config configs/rtdetrv3/rtdetrv3_r18vd_6x_coco.yml --summary converted/summary.json
