...
def default_collate_fn(batch):
    """
    Default batch collating function for a PyTorch data loader.
    ...
    numpy arrays as batch data. e.g. for
    ...
    Returns:
        Batched data: batched numbers and numpy arrays in input data.
    """
    sample = batch[0]
