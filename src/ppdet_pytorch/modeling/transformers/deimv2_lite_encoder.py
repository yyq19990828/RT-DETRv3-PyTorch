...
from ppdet_pytorch.modeling.shape_spec import ShapeSpec
...
class LiteEncoder(nn.Module):
    ...
    def __init__(
        ...
        fuse_block = RepNCSPELAN4(
            c1, c2, c3, c4, num_blocks, csp_type=csp_type
        )
    ...
    def forward(self, feats):
        ...
        projected = [
            module(feat) for module, feat in zip(self.input_proj, feats)
        ]
