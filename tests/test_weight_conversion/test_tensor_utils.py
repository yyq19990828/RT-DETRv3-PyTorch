...
Tests for tensor_utils module in tools/weight_conversion/tensor_utils.py
"""
...
from tools.weight_conversion.tensor_utils import (
    paddle_to_numpy,
    numpy_to_torch,
...
class TestTensorConversion:
    ...
    def test_convert_tensor(self):
        ...
        paddle_tensor = paddle.randn([2, 3, 4], dtype='float32')
    ...
    def test_paddle_to_numpy(self):
        """Test PaddlePaddle tensor to NumPy conversion"""
        import paddle

        paddle_tensor = paddle.randn([5, 10])
    ...
    def test_detect_dtype_paddle(self):
        """Test dtype detection for PaddlePaddle tensors"""
        import paddle

        tensor_fp32 = paddle.randn([2, 3], dtype='float32')
        tensor_fp64 = paddle.randn([2, 3], dtype='float64')
    ...
    def test_numerical_precision(self):
        ...
        paddle_tensor = paddle.to_tensor(values)
