...
__all__ = [
    'check_gpu', 'check_version', 'check_config'
...
def check_gpu(use_gpu):
    ...
    """
    err = "Config use_gpu cannot be set as true while CUDA is not available! \n" \
          "Please try: \n" \
...
def check_version(version='2.0'):
    ...
    """
    err = "PyTorch version {} or higher is required. \n" \
          "Please make sure the version is good with your code. \n" \
          "Current PyTorch version: {}".format(version, torch.__version__)

    try:
        # Get installed PyTorch version
        installed_version = torch.__version__.split('+')[0]  # Remove build info like '+cu118'
