...
sys.path.insert(0, str(project_root / "rtdetrv3_pytorch"))
sys.path.insert(0, str(project_root / "RT-DETRv3-paddle"))
...
def load_paddle_model():
    ...
    cfg = load_config(str(project_root / "configs/paddle/rtdetrv3/rtdetrv3_r18vd_6x_coco.yml"))
...
def load_pytorch_model():
    ...
    cfg = load_config(str(project_root / "configs/pytorch/rtdetrv3/rtdetrv3_r18vd_6x_coco.yml"))
    model = create(cfg.architecture)
