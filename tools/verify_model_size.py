...
def main():
    ...
    parser.add_argument(
        ...
        nargs='+',
        default=[
            'rtdetrv3_pytorch/configs/rtdetrv3/rtdetrv3_r18vd_6x_coco.yml',
            'rtdetrv3_pytorch/configs/rtdetrv3/rtdetrv3_r34vd_6x_coco.yml',
            'rtdetrv3_pytorch/configs/rtdetrv3/rtdetrv3_r50vd_6x_coco.yml',
        ],
