#!/usr/bin/env python3
"""Run a pinned DEIM-D-FINE model without importing its optional data stack."""
...
def main() -> None:
    ...
    parser.add_argument("--variant", required=True, choices=tuple("nsmlx"))
    ...
    config = yaml_config(
        str(
            args.upstream_root
            / f"configs/deim_dfine/deim_hgnetv2_{args.variant}_coco.yml"
        ),
        HGNetv2={"pretrained": False, "local_model_dir": None},
    )
