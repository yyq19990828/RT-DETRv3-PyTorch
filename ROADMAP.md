...
**Current execution plan**: [`D-FINE、DEIM 与 RT-DETRv4 集成计划`](docs/plans/2026-08-12-dfine-deim-rtdetrv4-integration.md)（in-progress，全部实现阶段与最终审计均已通过，等待维护者明确接受）；M4 长训保持 deferred
