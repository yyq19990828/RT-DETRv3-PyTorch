...
- [M6——性能、质量与发布计划](2026-07-19-m6-performance-quality-release.md)：进行中；Ruff 已覆盖全部活跃 Python 文件，Mypy 已覆盖整个 package 和纳入门禁的仓库脚本；Python 3.9–3.12 CPU CI、本机 CUDA/性能证据、wheel/sdist 发布候选验证、R18 COCO 可视化对比和 Models CLI 已完成，本地覆盖率门禁提高到 48%/71%。90% 覆盖率目标、权重公开发布及 URL 回读尚未完成。
