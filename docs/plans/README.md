...
- [M6——性能、质量与发布计划](2026-07-19-m6-performance-quality-release.md)：进行中；Ruff 已覆盖全部活跃 Python 文件，Mypy 已扩展到 36 个 source file，Python 3.9–3.12 托管 CPU CI、wheel smoke 和 44%/65% 覆盖率回退门禁已建立；完整 Mypy、CUDA、90% 覆盖率目标、性能和发布清单待推进。
