...
- [M6——性能、质量与发布计划](2026-07-19-m6-performance-quality-release.md)：进行中；Ruff 已覆盖全部活跃 Python 文件，Mypy 已覆盖整个 package 和纳入门禁的仓库脚本；Python 3.9–3.12 CPU CI、本机 CUDA/性能证据、wheel/sdist 发布候选验证、R18/R34/R50 COCO 可视化对比、四产物 Models CLI 和 11-asset checksum 发布预检已完成，托管覆盖率门禁提高到 50%/85%。90% 覆盖率目标、权重公开发布及 URL 回读尚未完成。
