...
- [M6——性能、质量与发布计划](2026-07-19-m6-performance-quality-release.md)：进行中；Ruff 已覆盖全部活跃 Python 文件，Python 3.9–3.12 托管 CPU CI 与 wheel smoke 已通过；完整 Mypy、CUDA、覆盖率、性能和发布清单待推进。
