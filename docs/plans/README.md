...
- [M6——性能、质量与发布计划](2026-07-19-m6-performance-quality-release.md)：进行中；Ruff 已覆盖全部活跃 Python 文件，Mypy 已覆盖整个 package 与 3 个质量/稳定性脚本，共 103 个 source file；本机 47%/66% 覆盖率回退门禁已通过，本批托管复验待完成；CUDA、90% 覆盖率目标、性能和发布清单待推进。
