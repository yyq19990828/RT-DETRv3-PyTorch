...
- [`models/`](models/README.md)：模型专属的当前合同，按模型分目录。RT-DETRv3 的配置迁移、CLI 与导出边界、已知限制见 [`models/rtdetrv3/`](models/rtdetrv3/README.md)。
- [`plans/`](plans/README.md)：活动与延期计划。当前唯一活动计划是 [M4 COCO 精度与稳定性](plans/2026-07-18-m4-coco-accuracy-stability.md)（deferred）；已完成计划移入归档。新计划可从 [`plans/TEMPLATE.md`](plans/TEMPLATE.md) 复制。
